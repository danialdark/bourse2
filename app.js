...
const headersGet = {
    ...
    'Accept-Language': 'en-US,en;q=0.9',
    'Connection': 'keep-alive',
    'Cookie': 'cookiesession1=678B28F25E2958B5FB0D2879D40E15CA; ClientId=e2cde128-d81c-48de-84b8-b0d8d9df4aad; e2cde128-d81c-48de-84b8-b0d8d9df4aad-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..iIayMaCCpIJREMQLl47achwJweg-mGq-bXqm-c09bNU',
    'Host': 'sm.exphoenixfuture.ir:8080',
    'Origin': 'https://sm.exphoenixfuture.ir',
    'Referer': 'https://sm.exphoenixfuture.ir/',
    'Sec-Fetch-Dest': 'empty',
    ...
    'Sec-Fetch-Site': 'same-site',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
    'clientId': 'e2cde128-d81c-48de-84b8-b0d8d9df4aad',
