...
const headersGet = {
    ...
    'Accept-Language': 'en-US,en;q=0.9',
    'Connection': 'keep-alive',
    'Cookie': 'cookiesession1=678B28F25E2958B5FB0D2879D40E15CA; ClientId=fc8c7092-259f-4e2d-84c4-282b919360ec; fc8c7092-259f-4e2d-84c4-282b919360ec-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..G2hGUZ3bYQ8Ahpi4-Dw_dcOV8kSSGOKa1eX0w3zQNxE',
    'Host': 'sm.exphoenixfuture.ir:8080',
    'Origin': 'https://sm.exphoenixfuture.ir',
    'Referer': 'https://sm.exphoenixfuture.ir/',
    'Sec-Fetch-Dest': 'empty',
    ...
    'Sec-Fetch-Site': 'same-site',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
    'clientId': 'fc8c7092-259f-4e2d-84c4-282b919360ec',
...
const symbolConfigs = [249, 229, 237, 238, 240, 242, 246, 248, 228, 250, 251, 257, 259, 260, 262, 263,264];
