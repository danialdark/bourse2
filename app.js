...
const headersGet = {
    ...
    'Accept-Language': 'en-US,en;q=0.9',
    'Connection': 'keep-alive',
    'Cookie': 'cookiesession1=678B28F25E2958B5FB0D2879D40E15CA; ClientId=dc83972c-eac2-48c3-adbd-c2307f98597d; dc83972c-eac2-48c3-adbd-c2307f98597d-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..NDANyQXDxJfpIeq0Fy-IBHOwq5dZOcBtK1nR-t9WVUA',
    'Host': 'sm.exphoenixfuture.ir:8080',
    'Origin': 'https://sm.exphoenixfuture.ir',
    'Referer': 'https://sm.exphoenixfuture.ir/',
    'Sec-Fetch-Dest': 'empty',
    ...
    'Sec-Fetch-Site': 'same-site',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
    'clientId': 'dc83972c-eac2-48c3-adbd-c2307f98597d',
