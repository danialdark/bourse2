...
const headersGet = {
    ...
    'Accept-Language': 'en-US,en;q=0.9',
    'Connection': 'keep-alive',
    'Cookie': 'cookiesession1=678B28F25E2958B5FB0D2879D40E15CA; ClientId=a1bd46a3-60ce-4dfb-85d8-4842f999ecf1; a1bd46a3-60ce-4dfb-85d8-4842f999ecf1-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..KUHmFIH_FEDjch9V2I4zct2yd1QTcZfANu2Z50v9Dc4',
    'Host': 'sm.exphoenixfuture.ir:8080',
    'Origin': 'https://sm.exphoenixfuture.ir',
    'Referer': 'https://sm.exphoenixfuture.ir/',
    'Sec-Fetch-Dest': 'empty',
    ...
    'Sec-Fetch-Site': 'same-site',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
    'clientId': 'a1bd46a3-60ce-4dfb-85d8-4842f999ecf1',
...
const symbolConfigs = [249, 229, 235, 237, 238, 240, 242, 245, 246, 248, 228, 250, 251, 257, 259, 260, 262, 263];
