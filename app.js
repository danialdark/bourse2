...
const headersGet = {
    ...
    'Accept-Language': 'en-US,en;q=0.9',
    'Connection': 'keep-alive',
    'Cookie': 'cookiesession1=678B28F25E2958B5FB0D2879D40E15CA; ClientId=cfac0338-cf19-4b6a-89d2-f9123716f572; cfac0338-cf19-4b6a-89d2-f9123716f572-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..OD32V42VvX0hmERPDSTOT8w2ALIMU8pRTOfG5KMJmhs',
    'Host': 'sm.exphoenixfuture.ir:8080',
    'Origin': 'https://sm.exphoenixfuture.ir',
    'Referer': 'https://sm.exphoenixfuture.ir/',
    'Sec-Fetch-Dest': 'empty',
    ...
    'Sec-Fetch-Site': 'same-site',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
    'clientId': 'cfac0338-cf19-4b6a-89d2-f9123716f572',
