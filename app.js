...
const headersGet = {
    ...
    'Accept-Language': 'en-US,en;q=0.9',
    'Connection': 'keep-alive',
    'Cookie': 'cookiesession1=678B28F25E2958B5FB0D2879D40E15CA; ClientId=1c124089-8ba2-4f1f-9ae5-71c40c91347b; 1c124089-8ba2-4f1f-9ae5-71c40c91347b-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..bkXmn-MZ1A6ObvWat38Zsy40Fe1RKObwuO1ewFp_nPQ',
    'Host': 'sm.exphoenixfuture.ir:8080',
    'Origin': 'https://sm.exphoenixfuture.ir',
    'Referer': 'https://sm.exphoenixfuture.ir/',
    'Sec-Fetch-Dest': 'empty',
    ...
    'Sec-Fetch-Site': 'same-site',
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
    'clientId': '1c124089-8ba2-4f1f-9ae5-71c40c91347b',
...
const symbolConfigs = [249, 229, 237, 238, 240, 242, 246, 248, 228, 250, 251, 257, 259, 260, 262, 263,264,265];
